...
/** Payment methods offered at cashier (includes BetterPay QR). */
 ...
 * @see https://pay.betterpay.online/pay/{PARTNER}?ref=&amount=&name=&phone=&patient_id=&description=
 */
async function buildBetterPayPaymentUrl(pool, opts = {}) {
  ...
  const base = String(cfg.baseUrl || 'https://pay.betterpay.online/pay').replace(/\/$/, '');
