...
const { REVENUE_SERVICE_ACCOUNTS } = require('./hospitalServiceRevenueAccounts');

/** OHADA 6-digit posting leaves (parents like 601000 are is_posting=0). */
...
const PURCHASE_STOCK_ACCOUNTS = {
  pharmacy: '311100',
  procurement: '311200',
  default: '311100',
};

const SUPPLIER_PAYABLE_ACCOUNT = '401100';
