...
const { loadCoaPayload: loadCoaFile } = require('./resolveCoaPath');

function loadCoaPayload() {
  return loadCoaFile().payload;
}
...
module.exports = {
  ...
  loadSeedAccounts,
  getCoaAccountByCode,
  resolveOhadaCoaPath: require('./resolveCoaPath').resolveCoaPath,
  resolveCoaPath: require('./resolveCoaPath').resolveCoaPath,
